...
def get_experiments():
  ...
  tensor_experiments_defn = [
    {
      "name": "func_approx_quantum",
      "simulator": {
        "type": "SLOS_probs",
        "params": {"workers": WORKERS, "split_factor": 1},
      },
    ...
    {
      "name": "func_approx_semiclassical",
      "simulator": {
